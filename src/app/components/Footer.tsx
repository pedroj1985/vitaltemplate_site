        ...
        <div className="grid md:grid-cols-3 gap-10 mb-10 items-center">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#home" className="hover:text-[#3270b3] transition-colors">Inicio</a></li>
              <li><a href="#services" className="hover:text-[#3270b3] transition-colors">Servicios</a></li>
              <li><a href="#pricing" className="hover:text-[#3270b3] transition-colors">Planes</a></li>
              <li><a href="#about" className="hover:text-[#3270b3] transition-colors">Sobre Nosotros</a></li>
              <li><a href="#contact" className="hover:text-[#3270b3] transition-colors">Contacto</a></li>
            </ul>
          </div>
          <div>
